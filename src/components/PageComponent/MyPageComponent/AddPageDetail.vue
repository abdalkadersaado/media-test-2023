<template>
    <div>
        <div class="row mt-3 pe-3">
            ...
            <textarea class="vinput__add-input"  v-model="descripton" id="" cols="30" rows="10"></textarea>
        </div>

        <div  class="row mt-3 pe-3">
            <p class="fw-bold mb-1">{{ $t("Address") }} : </p>
            <input class="vinput__add-input" type="text" v-model="address">
        </div>

        <div  class="row mt-3 pe-3">
            <p class="fw-bold mb-1">{{ $t("Service Area") }} : </p>
            <input class="vinput__add-input" type="text" v-model="service_area">
        </div>

        <div  class="row mt-3 pe-3">
            <p class="fw-bold mb-1">{{ $t("Email") }} : </p>
            <input class="vinput__add-input" type="text" v-model="email">
        </div>

        <div  class="row mt-3 pe-3">
            <p class="fw-bold mb-1">{{ $t("Website") }} : </p>
            <input class="vinput__add-input" type="text" v-model="website">
    
        </div>

        <div  class="row mt-3 pe-3">
            <p class="fw-bold mb-1">{{ $t("Phone") }} : </p>
            <input class="vinput__add-input" type="text" v-model="phone">
        </div>

        <div  class="row mt-3 pe-3">
            <p class="fw-bold mb-1">{{ $t("whatsApp Phone") }} : </p>
            <input class="vinput__add-input" type="text" v-model="whats_phone">
        </div>

        <div class="row mt-3 pe-3 mb-2 vinput__add-input">
        ...
        <button class="btn btn-primary mb-3" type="submit" @click="addnow(this.id)">Add Now</button>
...
export default {
  ...
  data() {
        return {
            ...
            saturday_start_time1: null,
            saturday_end_time1: null,
            saturday_start_time2: null,
            saturday_end_time2: null,

            sunday_start_time1: null,
            sunday_end_time1: null,
            sunday_start_time2: null,
            sunday_end_time2: null,

            monday_start_time1: null,
            monday_end_time1: null,
            monday_start_time2: null,
            monday_end_time2: null,

            tuesday_start_time1: null,
            tuesday_end_time1: null,
            tuesday_start_time2: null,
            tuesday_end_time2: null,

            wednesday_start_time1: null,
            wednesday_end_time1: null,
            wednesday_start_time2: null,
            wednesday_end_time2: null,
            
            thursday_start_time1: null,
            thursday_end_time1: null,
            thursday_start_time2: null,
            thursday_end_time2: null,

            friday_start_time1: null,
            friday_end_time1: null,
            friday_start_time2: null,
            friday_end_time2: null,
    ...
    methods: {
        async addnow(id) {
            ...
            await pageServices.AddPageDetail(id, data).then(
                response => {
                    console.log(response.data.data)
                    this.$emit('addpagedetail')
