  ...
  <div>
    <div class="row me-0 mb-3 bg-white">
      <div class="card add_post_card">
        <div class="row justify-content-center overflow-hidden align-items-center">
          <div class="col-2 overflow-hidden">
            <img
              class="page-profile"
              v-if="img.has_media_profile === false"
              src="@/assets/img_friends/default1.png"
              alt=""
            />
            <img
              class="page-profile"
              v-else-if="img.media[0].collection_name === 'profile'"
              :src="img.media[0].src_url"
              alt=""
            />
            <img
              class="page-profile"
              v-else-if="img.media[1].collection_name === 'profile'"
              :src="img.media[1].src_url"
              alt=""
            />
          </div>
...
export default {
  ...
  methods: {
    ...
    close() {
      ...
      (this.postsmedia = []), (this.ispageloading = null);
    },
    uploadFile() {
    ...
    async submitFile(id) {
      ...
      await pageServices.AddPostInPage(id, raw, this.content).then((response) => {
