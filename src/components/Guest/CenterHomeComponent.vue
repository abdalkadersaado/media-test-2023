<template>
  <div class="col-md-12 col-lg-6 col-sm-12 py-0 center" id="aa">
    <!-- Story Section -->
    <StoryComponent />
    <!-- Story Section -->
...
import SkeltonComponent from "@/components/Guest/SkeltonComponent.vue";
import AddpostComponent from "@/components/Guest/AddpostComponent.vue";
