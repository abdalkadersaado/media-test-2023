          ...
          <div class="card-header bg-white border-bottom-0 d-flex justify-content-between">
            <div class="d-flex align-items-center">
              ...
              <div class="ms-3">
                ...
                >{{ post.model.first_name }} {{ post.model.last_name }}</p>
                <p v-else class="mb-0">
                  {{ post.model.name
                  }}
                  <small
        ...
        <div class="card card_post">
          ...
          >
            <div class="d-flex align-items-center">
              <div>
                <img
                  v-if="post_page.page.has_media_profile === false"
                  src="@/assets/img_friends/default1.png"
                  alt=""
                />
                <img
                  v-else-if="
                    post_page.page.media[0].collection_name.includes('profiles')
                  "
                  :src="post_page.page.media[0].icon"
                  alt=""
                />
                <img
                  v-else-if="
                    post_page.page.media[1].collection_name.includes('profiles')
                  "
                  :src="post_page.page.media[1].icon"
                  alt=""
                />
              </div>
              <div class="ms-3">
          ...
          <div class="card-body">
            <p v-if="post_page.content" class="card-text">
              {{ post_page.content }}
            </p>
            <div v-if="post_page.has_media" class="media_container">
              <div class="media_one" v-if="post_page.media.length === 1">
                <img
                  v-if="post_page.media[0].media_type.includes('Image')"
                  :src="post_page.media[0].src_url"
                  alt=""
                />
              ...
              >
                ...
                <div class="media_two_box">
                  <img
                    v-if="post_page.media[1].media_type.includes('Image')"
                    :src="post_page.media[1].src_url"
                    alt=""
                  />
              ...
              <div class="media_three" v-if="post_page.media.length === 3">
                ...
                <div class="media_three_box_under">
                  <img
                    v-if="post_page.media[2].media_type.includes('Image')"
                    :src="post_page.media[2].src_url"
                    alt=""
                  />
              ...
              <div class="media_four" v-if="post_page.media.length === 4">
                ...
                <div class="media_four_box">
                  <img
                    v-if="post_page.media[3].media_type.includes('Image')"
                    :src="post_page.media[3].src_url"
                    alt=""
                  />
              ...
              <div class="media_bigger" v-if="post_page.media.length > 4">
                ...
                >
                  <span>+{{ post_page.media.length - 4 }}</span>
                </p>
              </div>
            </div>
