<template>
  <div class="col-md-2 left">
    ...
    <div class="row left_box align-items-center">
      ...
      <div class="col-md-8 offset-lg-2 left_box_info">
        <span
          ><router-link class="router-link-to-profile" to="/friends">{{
            $t("Friends")
          }}</router-link></span
        >
      </div>
    ...
    <div class="row left_box align-items-center">
      ...
      <div class="col-md-8 offset-lg-2 left_box_info">
        <span>
          <router-link class="router-link-to-profile" to="/group">{{
            $t("Groups")
          }}</router-link>
        </span>
      </div>
    ...
    <div class="row left_box align-items-center">
      ...
      <div class="col-md-8 offset-lg-2 left_box_info">
        <span>
          <router-link class="router-link-to-profile" to="watch">
            {{ $t("Watch") }}</router-link
          >
        </span>
      </div>
    ...
    <div class="row left_box align-items-center">
      ...
      <div class="col-md-8 offset-lg-2 left_box_info">
        <span>
          <router-link class="router-link-to-profile" to="/pages">
            {{ $t("Pages") }}
          </router-link>
        </span>
      </div>
    ...
    <div class="row left_box align-items-center">
      ...
      <div class="col-md-8 offset-lg-2 left_box_info">
        <span>
          <router-link class="router-link-to-profile" to="/events">{{
            $t("Events")
          }}</router-link>
        </span>
      </div>
    ...
    <div class="row left_box align-items-center">
      ...
      <div class="col-md-8 offset-lg-2 left_box_info">
        <span>
          <router-link class="router-link-to-profile" to="/reels">{{
            $t("Reels")
          }}</router-link>
        </span>
      </div>
