      ...
      <div class="card card_skelton">
        ...
        >
            <div class="d-flex align-items-center">
                ...
                <img class="img" v-else-if="user.profile.media[0].collection_name === 'profile'" :src="user.media[0].src_url" alt="" />
                <img class="img" v-else-if="user.profile.media[1].collection_name === 'profile'" :src="user.media[1].src_url" alt="" />
                <div class="ms-3">
                    <p class="mb-0 " >
