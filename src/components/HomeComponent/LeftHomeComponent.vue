  ...
  <div class="col-md-2 left">
    <div class="row left_box align-items-center">
      ...
      <div class="col-md-8 offset-lg-2 left_box_info">
        <router-link class="router-link-to-profile" :to="{ name: 'personal-profile' }">
    ...
    <div class="row left_box align-items-center">
      ...
      <div class="col-md-8 offset-lg-2 left_box_info">
        <span
          ><router-link class="router-link-to-profile" to="/friends" title="Friends">{{
            $t("Friends")
          }}</router-link></span
        >
      </div>
    ...
    <div class="row left_box align-items-center">
      ...
      <div class="col-md-8 offset-lg-2 left_box_info">
        <router-link class="router-link-to-profile" to="/watch" title="Groups"
          ><span>{{ $t("Groups") }}</span></router-link
        >
      </div>
    </div>
    ...
    <div class="row left_box align-items-center">
      ...
      <div class="col-md-8 offset-lg-2 left_box_info">
        <router-link class="router-link-to-profile" to="/watch" title="Watches"
          ><span>{{ $t("Watch") }}</span></router-link
        >
      </div>
    </div>
    ...
    <div class="row left_box align-items-center">
      ...
      <div class="col-md-8 offset-lg-2 left_box_info">
        <router-link class="router-link-to-profile" to="/pages" title="Pages"
          ><span>{{ $t("Pages") }}</span></router-link
        >
      </div>
    </div>
    ...
    <div class="row left_box align-items-center">
      ...
      <div class="col-md-8 offset-lg-2 left_box_info">
        <router-link class="router-link-to-profile" to="watch" title="Events">
          <span>{{ $t("Events") }}</span>
        </router-link>
      </div>
    </div>
    ...
    <div class="row left_box align-items-center">
      ...
      <div class="col-md-8 offset-lg-2 left_box_info">
        <router-link class="router-link-to-profile" to="watch" title="Reels"
          ><span>{{ $t("Reels") }}</span></router-link
        >
      </div>
    </div>
  </div>
