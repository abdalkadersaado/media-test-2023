<template>
  ...
  <div class="profile-container">
    ...
    />
    <img
      v-else-if="this.userInformation.has_media_cover === true"
      class="cover-img"
    ...
    <div class="profile-details">
      <div class="pd-left">
        <div class="pd-row">
          ...
          />
          <img
            v-else-if="this.userInformation.has_media_profile === true"
    ...
    <div class="tabs-content">
      <div class="content-one" v-if="activeTab === '1'">
        <div class="profile-info">
          <div class="info-col">
            <div class="profile-intro" v-if="this.userInformation.publicdetail != null">
              <div class="loading-info" v-if="!loading_info">
                <h3>{{ $t("Biography") }}</h3>
                <p class="intro-text" v-if="this.userInformation.length != 0">
                  <span v-if="this.userInformation.publicdetail[2].details.value"
                    >{{ this.userInformation.publicdetail[2].details.value }}
                    <img src="@/assets/images/feeling.png"
                  /></span>
                  <span v-else class="text-center"> {{ $t("no value specified") }}</span>
                </p>
                <hr />
                <ul v-if="this.userInformation.length != 0">
                  ...
                  <li>
                    ...
                    <span
                      ...
                      >{{ this.userInformation.publicdetail[1].details.value }}</span
                    >
                  ...
                  <li>
                    ...
                    <span
                      ...
                      class="details-margin"
                      >{{ this.userInformation.publicdetail[0].details.value }}</span
                    >
                    <span v-else class="details-margin">
                      {{ $t("no value specified") }}</span
                    >
                  ...
                  <li>
                    <b>{{ this.$i18n.t(this.userInformation.publicdetail[3].key_en) }}</b>
                    :
          ...
          <div class="post-col">
            <div class="write-post-container">
              ...
              <div class="post-input-container">
                <textarea rows="3" placeholder="what's on your mind,abd?"></textarea>
