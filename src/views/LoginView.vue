                ...
                <div class="card-body">
                  ...
                  <form @submit.prevent="loginUser">
                    <div class="form-outline mb-2">
                      <label class="form-label custom_text" for="form2Example11">{{
                        $t("Username")
                      }}</label>
                      <input
                        type="text"
                    ...
                    <div class="form-outline mb-2">
                      <label class="form-label custom_text" for="form2Example22">{{
                        $t("Password")
                      }}</label>
                      <input
                        type="password"
                    ...
                    <div class="text-center mt-5 mb-3 align-items-center">
                      ...
                      <a class="custom_text text-decoration-none ms-3" href="#!">{{
                        $t("Forgot password?")
                      }}</a>
                    </div>
                    <div
                      v-if="!waiting"
                      class="d-flex justify-content-center auth align-items-center row"
                    >
                    ...
                    <div
                      v-else
                      class="d-flex justify-content-center auth align-items-center"
                    >
                    ...
                    >
                      ...
                      <div class="col-9">
                        <p @click="handleGoogleLogin()">Login with Google</p>
                      </div>
                    </div>
                    <div
                      v-else
                    ...
                    <div class="d-flex align-items-center justify-content-center pb-4">
                      ...
                      <button type="button" @click="register" class="btn custom_button">
                        {{ $t("Create new") }}
                      </button>
                    </div>
                  </form>
